...
Widget getWeatherIcon({String weatherDescription, Color color, double size}){
  ...
  switch(weatherDescription){
    ...
    case "Clouds":
      {return Icon(FontAwesomeIcons.cloud, color: Colors.lightBlueAccent, size: size);}
      break;

    case "Rain" :
      {return Icon(FontAwesomeIcons.cloudRain, color: Colors.lightBlue, size: size);}
      break;

    case "Snow" :
      {return Icon(FontAwesomeIcons.snowman, color: Colors.white, size: size);}
      break;
